...
static int FreeTypeGetFontBitMap(unsigned int dwCode, PFontBitMap ptFontBitMap)
{
	...
	ptFontBitMap->iXLeft       = iPenX + slot->bitmap_left;
	ptFontBitMap->iYTop        = iPenY - slot->bitmap_top;
	ptFontBitMap->iXMax        = ptFontBitMap->iXLeft + slot->bitmap.width;
	ptFontBitMap->iYMax        = ptFontBitMap->iYTop  + slot->bitmap.rows;
	ptFontBitMap->iBpp         = 1;
	ptFontBitMap->iPitch       = slot->bitmap.pitch;
	ptFontBitMap->iNextOriginX = iPenX + slot->advance.x / 64;
